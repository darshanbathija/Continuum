...
final class WireV20WorkspaceTabsTests: XCTestCase {
    ...
    func test_wireVersionAndGateExposeTabContext() {
        ...
        XCTAssertEqual(AgentControlWireVersion.tabContextMinimum, 20)
        XCTAssertFalse(AgentControlWireVersion.supportsTabContext(serverWireVersion: 19))
        XCTAssertTrue(AgentControlWireVersion.supportsTabContext(serverWireVersion: 20))
    }
