    ...
    public init(bundle: Bundle) {
        ...
        if let cacheURL = Self.cacheURL,
           ...
           let table = Self.decodeTable(from: data) {
            ...
            self.logger.info("Pricing loaded \(table.models.count, privacy: .public) models from runtime cache")
            return
        }
        ...
        self.models = table.models
        self.modelKeys = table.keys
        self.logger.info("Pricing loaded \(table.models.count, privacy: .public) models from bundle")
    }
