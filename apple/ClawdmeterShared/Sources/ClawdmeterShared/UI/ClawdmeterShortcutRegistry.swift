...
public struct ClawdmeterShortcutRegistry: Codable, Hashable, Sendable {
    ...
    public static let defaults: [ClawdmeterShortcut] = [
        ...
        .init(id: "session.new", label: "New workspace", key: "N", modifiers: [.command], scope: .session, commandID: "session.new"),
        .init(id: "code.newChatTab", label: "New chat tab", key: "T", modifiers: [.command], scope: .code, commandID: "code.newChatTab"),
        .init(id: "code.newTerminalTab", label: "New terminal tab", key: "T", modifiers: [.command, .shift], scope: .code, commandID: "code.newTerminalTab"),
        ...
        .init(id: "session.rename", label: "Rename open session", key: "R", modifiers: [.command, .shift], scope: .session, commandID: "session.rename"),
        .init(id: "session.archive", label: "Archive open session", key: "A", modifiers: [.command, .shift], scope: .session, commandID: "session.archive"),
        ...
        .init(id: "composer.permission.ask", label: "Permission mode: Ask", key: "1", modifiers: [.command, .shift], scope: .composer, commandID: "composer.permission.ask"),
        .init(id: "composer.permission.acceptEdits", label: "Permission mode: Accept edits", key: "2", modifiers: [.command, .shift], scope: .composer, commandID: "composer.permission.acceptEdits"),
        .init(id: "composer.permission.plan", label: "Permission mode: Plan", key: "3", modifiers: [.command, .shift], scope: .composer, commandID: "composer.permission.plan"),
        .init(id: "composer.permission.bypass", label: "Permission mode: Bypass", key: "4", modifiers: [.command, .shift], scope: .composer, commandID: "composer.permission.bypass"),
